...
(function () {
	...
	function setupSoundsAndEffects() {
		...
		guitars.addEffect(delay);
		guitars.addEffect(flanger);
		guitars.addEffect(distortion);
		guitars.addEffect(lowPassFilter);

		bass.addEffect(lowPassFilter);

		drums.addEffect(lowPassFilter);
	...
	function bindSliders() {
		var slidersValues = {
			'audio-volume': [
				{ element: drums, parameter: 'volume' },
				{ element: guitars, parameter: 'volume' },
				{ element: bass, parameter: 'volume' }
			],
